 ...
 *
 * This is code with all bits needed to validate and format date strings as dd/mm/ccyy or yyyy-mm-dd
 *
 */ 
 @Canonical 
 public class DateSupport
 {
   ...
   /** 
    * Variable to identify type of separator in this string as 1=. 2=/ 3=-
    */  
    int separatorType = 0;
   ...
   /** 
    * Variable to hold individual string tokens when divied by a type of separator in this string as 1=. 2=/ 3=-
    */  
    def tokens = []
   ...
   /** 
    * Method to test if each char. of a text string has valid allowable characters.
    * 
    ...
    * 
    * if valid string then tokens[] holds 3 pieces
    * and separatorType has a positive value of 1 or 2 or 3 if txt string contains known date separator of . / -
    *
   ...
   /** 
    * Method to test if text string holding a date in iso format of dd/mm/yyyy into a date object
    * 
    * logic uses slash ( / ) separator  
    *
    * @param txt holds string used to translate into an actual date object
    ...
    */     
    public boolean isDate(String txt)
    {
    	...
    	boolean flag2 = yn && flag1 && (tokens[0].size() == 2 || 1) ? true : false; // dd
   		boolean flag3 = yn && flag1 && (tokens[1].size() == 2 || 1) ? true : false; // mm
   		boolean flag4 = yn && flag1 && (tokens[2].size() == 4 || 2) ? true : false; // yyyy or yy
